...
from .auth.views import RegisterView, LoginView, LogoutView, RequestPasswordResetEmail, SetNewPasswordAPIView, \
    VerifyEmail
from .views import userssettings, Availablity, address, Notes
...
urlpatterns = [
    ...
    path('availablity', Availablity.Views.as_view(), name='availablities'),
    path('Availablity/<int:pk>/', Availablity.View.as_view(), name='availablity'),
