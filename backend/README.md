...
## Project Structure
    ...
    ├── djangotests_28782  # Django project configurations
...
1. Clone this repo and `cd djangotests_28782`
...
2. Clone this repo and `cd djangotests_28782`
...
### code readably
1. tests files
2. functions/classes description