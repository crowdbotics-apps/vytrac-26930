    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='symptoms_history', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('muserments', models.ManyToManyField(blank=True, related_name='RPMplan', to='timesheets.Column')),
                ('users', models.ManyToManyField(blank=True, related_name='RPMplan', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted', models.DateTimeField(editable=False, null=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('symptom', models.ManyToManyField(to='patients.Disease')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='Disease', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
